...
var ReactDataGrid = createClass((_createClass = {
...
}, _defineProperty(_createClass, 'componentDidMount', function componentDidMount() {
    this.rowCache = {};
...
}), _defineProperty(_createClass, 'componentDidUpdate', function componentDidUpdate(prevProps) {
...
}), _defineProperty(_createClass, 'prepareStyle', function prepareStyle(props) {
    var style = {};

    assign(style, props.defaultStyle, props.style);

    return style;
}), _defineProperty(_createClass, 'prepareClassName', function prepareClassName(props) {
...
}), _defineProperty(_createClass, 'prepareColumns', function prepareColumns(props, state) {
...
}), _defineProperty(_createClass, 'prepareColumnStyle', function prepareColumnStyle(props, column) {
...
}), _defineProperty(_createClass, 'prepareColumnSizes', function prepareColumnSizes(props, state) {
...
}), _defineProperty(_createClass, 'prepareResizeProxy', function prepareResizeProxy(props, state) {
    return _react2.default.createElement(ResizeProxy, { ref: 'resizeProxy', active: state.resizing });
}), _defineProperty(_createClass, 'onColumnResizeDragStart', function onColumnResizeDragStart(config) {
...
}), _defineProperty(_createClass, 'onColumnResizeDrag', function onColumnResizeDrag(config) {
    this.refs.resizeProxy.setState({
        offset: this.resizeProxyLeft + config.resizeProxyDiff
    });
}), _defineProperty(_createClass, 'onColumnResizeDrop', function onColumnResizeDrop(config, resizeInfo) {
